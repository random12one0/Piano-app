      ...
      <div className="flex w-full max-w-md flex-col gap-4 border border-rule bg-background p-5 shadow-[0_16px_48px_rgba(0,0,0,0.4)]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            disabled={isPending}
            className="ml-auto inline-flex min-h-11 cursor-pointer items-center px-2 font-mono text-xs font-medium uppercase tracking-wider text-foreground-dim transition-colors hover:text-flag disabled:opacity-50"
          >
            Delete song
          </button>
        </div>
