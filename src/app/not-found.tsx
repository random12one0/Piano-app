...
export default function NotFound() {
  return (
    <div className="mx-auto flex w-full max-w-xl flex-1 flex-col justify-center px-6 py-24 sm:px-10">
      <p className="mb-2 font-mono text-xs uppercase tracking-[0.2em] text-accent">Not found</p>
      ...
      <Link
        href="/"
        className="mt-8 inline-flex min-h-11 w-fit items-center border border-accent px-4 font-mono text-xs uppercase tracking-wider text-accent transition-colors hover:bg-accent hover:text-accent-contrast"
      >
        ← Back to library
      </Link>
    </div>
